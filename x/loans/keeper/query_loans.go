...
func (k Keeper) LoansAll(goCtx context.Context, req *types.QueryAllLoansRequest) (*types.QueryAllLoansResponse, error) {
	if req == nil {
...
func (k Keeper) Loans(goCtx context.Context, req *types.QueryGetLoansRequest) (*types.QueryGetLoansResponse, error) {
	if req == nil {
		return nil, status.Error(codes.InvalidArgument, "invalid request")
	}
